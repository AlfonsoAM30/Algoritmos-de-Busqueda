...
import BusquedasLocales.FirstImprovement;
...
public class MemeticoConReps {
    ...
    public MemeticoConReps(Instancia instancia, int tamanioPoblacion, int iteraciones,
        ...
        for (int i = 0; i < this.iteraciones; i++) {
            ...
            if (i % 10 == 0) {
                for (int j = 0; j < tamanioPoblacion; j++) {
                    O.set(j, busquedaLocal.run(O.get(j), instancia));
                }
            }
